...
//function  sndRecs( pRes, mRecs, aSQL, aDatasetName, aOnRouteFnc ) {                                       //#.(30331.01.3).(30407.03.8)
  function  sndRecs( mRecs, aSQL, aEntity, pRes, aOnRouteFnc ) {                                            // .(30608.04.1  RAM Changge aDataSetName to aEntity).(30407.03.8)
...
//     var  pRecs      =  mRecs; if (aEntity) { pRecs = {}; pRecs[aRecords]     = mRecs }                   //#.(30404.01.2)
            ...
            aEntity    =  aEntity.replace( /^\//, '' ).replace( /\/.*/, '' )                                // .(30608.04.2)                                  
...
//  ------  ---- ----- =  ------|  -------------------------------- ------------------- ------------------+
  ...
  function  sndJSON( pRes, aJSON, aEntity ) {
        ...
        if (aEntity) {
                 sayMsg( `JSON Object, '${ aEntity.replace( /^\//, '' ).replace( /\/.*/, '' ) }', sent` ) } // .(30608.04.4).(30528.04.4 RAM No \n).(30526.01.15)
